  ...
  return (
    <>
      ...
      <main className="flex-1 p-8 lg:p-10 space-y-12 max-w-[1600px] mx-auto w-full">
        {/* Header Hero Section */}
        <section className="relative h-[480px] rounded-xl overflow-hidden flex items-center px-12 lg:px-20 group border-8 border-white shadow-2xl">
          <Image 
          ...
          <div className="relative z-10 max-w-2xl space-y-8">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-md bg-secondary-container/20 backdrop-blur-xl border border-white/10">
            ...
            <div className="pt-4 flex gap-6">
                <Button className="h-12 px-10 rounded-sm bg-white text-primary font-black uppercase text-[11px] tracking-widest hover:scale-105 active:scale-95 transition-all">
                    Our Mission
                </Button>
                <Button variant="ghost" className="h-12 px-10 rounded-sm border-2 border-white/20 text-white font-black uppercase text-[11px] tracking-widest hover:bg-white/10">
                    Watch Documentary
                </Button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          <div className="md:col-span-12 lg:col-span-8 space-y-10">
            <div className="bg-surface-container-lowest p-12 rounded-xl shadow-sm border border-surface-container/50">
              <div className="flex items-center gap-6 mb-10">
                <div className="size-16 rounded-md bg-primary/5 flex items-center justify-center text-primary group">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-surface-container-low p-8 rounded-xl border-l-8 border-primary flex flex-col justify-between group cursor-default hover:bg-white transition-colors">
                ...
                <div className="bg-surface-container-low p-8 rounded-xl border-l-8 border-secondary flex flex-col justify-between group cursor-default hover:bg-white transition-colors">
                  <div className="space-y-4">
            ...
            <div className="bg-surface-container p-10 rounded-xl grid grid-cols-1 md:grid-cols-3 gap-10 relative overflow-hidden border border-surface-container">
                {[
                ...
                {/* Decoration */}
                <div className="absolute top-0 right-0 size-40 bg-primary/5 rounded-xl blur-3xl"></div>
            </div>
          </div>

          {/* Agency Sidebar Card */}
          <div className="md:col-span-12 lg:col-span-4 h-full">
            <div className="bg-primary text-white p-12 rounded-xl h-full relative overflow-hidden flex flex-col justify-between shadow-2xl shadow-primary/20">
              <div className="space-y-10 relative z-10">
                <div className="size-20 bg-white/10 rounded-md flex items-center justify-center backdrop-blur-2xl border border-white/5 shadow-xl">
                ...
                <div className="space-y-4">
                    ...
                    <div className="h-1.5 w-16 bg-secondary-fixed rounded-sm"></div>
                </div>
                ...
                <div className="space-y-6 pt-4">
                  <div className="flex items-center gap-4 group cursor-pointer">
                    <div className="size-10 rounded-md bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-colors">
              ...
              <Button className="mt-12 w-full h-12 bg-secondary text-white font-black uppercase text-[11px] tracking-widest rounded-sm border-none shadow-xl shadow-black/10 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 relative z-10">
                  Contact Agency
                  <LucideExternalLink className="size-4" />
              </Button>
              {/* Background Art */}
              <div className="absolute -bottom-20 -right-20 size-80 bg-white/5 rounded-xl blur-[100px] pointer-events-none"></div>
            </div>
          </div>
        </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-10">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-6">
                {[
                    ...
                    <div key={i} className="h-12 px-8 bg-surface-container-high rounded-md flex items-center gap-4 border border-surface-container/50">
          ...
          <div className="relative rounded-xl overflow-hidden h-80 bg-surface-container border-8 border-white shadow-2xl">
            <Image 
