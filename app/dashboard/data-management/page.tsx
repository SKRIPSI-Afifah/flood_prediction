      ...
      <main className="flex-1 p-8 lg:p-10 space-y-10 max-w-[1600px] mx-auto w-full">
        ...
        <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm border border-surface-container/50">
          ...
          <div className="px-10 py-6 bg-surface-container-low/30 flex justify-between items-center border-t border-surface-container/50">
            ...
            <div className="flex gap-2">
              <button className="size-9 flex items-center justify-center rounded-sm hover:bg-surface-variant transition-colors text-primary">
              ...
              <button className="size-9 flex items-center justify-center rounded-sm hover:bg-surface-variant text-xs font-black text-primary transition-colors">2</button>
              <button className="size-9 flex items-center justify-center rounded-sm hover:bg-surface-variant text-xs font-black text-primary transition-colors">3</button>
              <button className="size-9 flex items-center justify-center rounded-sm hover:bg-surface-variant transition-colors text-primary">
        ...
        <div className="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-surface-container-high p-12 rounded-xl flex flex-col justify-between border border-surface-container/50">
            ...
            <Button className="w-full bg-surface-container-highest hover:bg-surface-variant text-primary border border-primary/10 font-black text-[10px] h-12 rounded-sm uppercase tracking-widest transition-all">
              Manual Sync
            </Button>
          </div>
        </div>
