    ...
    <>
      ...
      <main className="flex-1 p-8 lg:p-10 space-y-10 max-w-[1600px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          {/* Input Form Card */}
          <div className="lg:col-span-12 xl:col-span-7 bg-surface-container-lowest rounded-[48px] shadow-sm overflow-hidden flex flex-col border border-surface-container/50">
            ...
            <form className="p-10 space-y-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-4">
                  ...
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" placeholder="Contoh: 125" type="number"/>
                </div>
                <div className="space-y-4">
                  <label className="text-[10px] font-black text-on-surface-variant/40 uppercase tracking-[0.2em] flex items-center gap-3">
                  ...
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" placeholder="Contoh: 15.5" type="number"/>
                </div>
                <div className="space-y-4">
                  <label className="text-[10px] font-black text-on-surface-variant/40 uppercase tracking-[0.2em] flex items-center gap-3">
                  ...
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" placeholder="Contoh: 5.2" type="number"/>
                </div>
                <div className="space-y-4">
                  <label className="text-[10px] font-black text-on-surface-variant/40 uppercase tracking-[0.2em] flex items-center gap-3">
                  ...
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" placeholder="Contoh: 40" type="number"/>
                </div>
              </div>
              <div className="pt-4">
                <Button className="w-full bg-gradient-to-r from-primary to-primary-container text-white border-none font-black text-[12px] h-16 rounded-[24px] uppercase tracking-[0.2em] shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4 group" type="submit">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-10">
            {/* Result Display Card */}
            <div className="bg-surface-container-lowest rounded-[48px] shadow-sm border border-surface-container/50 overflow-hidden group">
              ...
              <div className="p-12 flex flex-col items-center text-center relative">
                ...
                <div className="w-full space-y-6 pt-10 border-t border-surface-container/50">
                  ...
                  <div className="w-full h-4 bg-surface-container rounded-full overflow-hidden p-1 shadow-inner">
                    <div className="h-full bg-gradient-to-r from-primary to-primary-container rounded-full shadow-lg transition-all duration-[2000ms] ease-out" style={{ width: '89.4%' }}></div>
                  </div>
            ...
            <div className="relative h-72 rounded-[48px] overflow-hidden shadow-2xl shadow-primary/10 group cursor-pointer border-4 border-white">
              <Image 
              ...
              <div className="absolute bottom-8 left-8 right-8 glass-panel p-6 rounded-[32px] flex items-center justify-between border border-white/20 shadow-2xl backdrop-blur-3xl">
                <div className="flex items-center gap-4">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
                ...
                <div key={i} className="bg-surface-container-low p-8 rounded-[40px] flex items-start gap-6 border border-surface-container/50 hover:bg-surface-container transition-colors duration-500">
                    <div className={`size-14 shrink-0 rounded-2xl flex items-center justify-center ${item.color} shadow-lg shadow-black/5`}>
