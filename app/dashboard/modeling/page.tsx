    ...
    <>
      ...
      <main className="flex-1 p-8 lg:p-10 space-y-10 max-w-[1600px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <section className="md:col-span-12 lg:col-span-5 bg-surface-container-lowest rounded-[48px] p-10 shadow-sm border border-surface-container/50 flex flex-col">
            ...
            <form className="space-y-8 flex-1">
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" id="learning-rate" step="0.01" type="number" defaultValue="0.1"/>
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" id="max-depth" type="number" defaultValue="6"/>
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <input className="w-full bg-surface-container-low border-none rounded-2xl px-6 py-4 text-primary font-black focus:ring-2 focus:ring-primary/20 transition-all outline-none" id="n-estimators" type="number" defaultValue="100"/>
              ...
              <div className="pt-6">
                <Button className="w-full bg-gradient-to-r from-primary to-primary-container text-white h-16 rounded-[24px] font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all text-xs border-none" type="button">
          ...
          <div className="md:col-span-12 lg:col-span-7 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="bg-surface-container-lowest rounded-[32px] p-8 shadow-sm border-l-8 border-secondary flex flex-col justify-between">
              ...
              <div className="bg-surface-container-lowest rounded-[32px] p-8 shadow-sm border-l-8 border-primary-container flex flex-col justify-between">
            ...
            {/* Console Output */}
            <section className="flex-1 bg-on-surface rounded-[40px] p-8 shadow-2xl relative overflow-hidden flex flex-col min-h-[400px]">
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-surface-container-lowest/10">
                <div className="flex items-center gap-3">
                  <div className="size-8 bg-secondary/10 rounded-xl flex items-center justify-center">
          ...
          <section className="col-span-12 bg-primary text-white rounded-[48px] overflow-hidden shadow-2xl shadow-primary/20 flex flex-col lg:flex-row items-stretch">
            <div className="flex-1 p-12 lg:p-16 space-y-8 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Button className="bg-white text-primary hover:bg-white/90 border-none font-black text-[10px] h-14 px-10 rounded-2xl uppercase tracking-widest transition-all">
                  <LucideBookOpen className="size-4 mr-2" />
                  Documentation
                </Button>
                <Button className="bg-transparent text-white border border-white/20 hover:bg-white/10 font-black text-[10px] h-14 px-10 rounded-2xl uppercase tracking-widest transition-all">
