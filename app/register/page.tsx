    ...
    return (
      <main className="min-h-screen w-full flex flex-col items-center justify-center bg-white p-6">
        <div className="w-full max-w-md text-center cal-card p-10">
          ...
          <h3 className="font-heading text-2xl font-semibold tracking-tight text-[#242424]">Request Submitted</h3>
          <p className="text-sm text-[#898989] mt-4 font-sans leading-relaxed">
          ...
          <Link href="/login" className="block mt-10">
            <Button className="w-full py-6 bg-[#242424] text-white rounded-sm font-semibold text-sm hover:opacity-70 transition-opacity">
              RETURN TO PORTAL
            </Button>
          </Link>
        </div>
        ...
        <div className="cal-card p-10">
          ...
          <form className="space-y-5" action={handleSubmit}>
            ...
            <Button 
              type="submit"
              disabled={isPending}
              className="w-full mt-4 py-6 bg-[#242424] text-white rounded-sm font-semibold text-sm hover:opacity-70 transition-opacity flex items-center justify-center gap-2 border-none"
            >
