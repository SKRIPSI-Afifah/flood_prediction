...
const badgeVariants = cva(
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap focus-visible:border-ring focus-visible:ring-ring/50 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-sm shadow-primary/15",
        secondary:
          "bg-secondary-container text-on-secondary-container shadow-sm shadow-secondary/10",
        destructive:
          "bg-error-container text-on-error-container shadow-sm shadow-error/10",
        outline:
          "border-border bg-surface text-foreground shadow-ring",
        ghost:
